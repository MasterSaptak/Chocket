...
export default function AuthPage() {
        ...
        message = (
          <div className="flex flex-col gap-2">
            ...
            <p className="text-xs leading-normal opacity-70">
              Please add your current domain to the 
              <strong> Firebase Console &rarr; Authentication &rarr; Settings &rarr; Authorized Domains </strong> list.
            </p>
          </div>
        ) as any;
  ...
  const handleGoogleAuth = async () => {
    ...
    try {
      ...
      // If we have a role, the Redirection Logic in useEffect will handle it
      // If not, it will self-heal
      toast.success('Welcome back! 🍫');
    } catch (error: any) {
                ...
                <form onSubmit={handleEmailAuth} className="space-y-5">
                  ...
                  <div className="relative py-2">
                    <div className="absolute inset-0 flex items-center">
                      <div className="w-full border-t border-[#3E2723]/50"></div>
                    </div>
                    <div className="relative flex justify-center text-xs">
                      <span className="px-3 bg-[#1A0F0B] text-[#FFF3E0]/20 font-bold uppercase tracking-widest">Or continue with</span>
                    </div>
                  </div>
                  ...
                  <button 
                    ...
                    disabled={isLoading}
                    className="w-full py-4 bg-[#1A0F0B] border border-[#3E2723] text-[#FFF3E0] font-bold rounded-xl flex items-center justify-center gap-3 hover:bg-[#3E2723]/20 transition-all active:scale-95 disabled:opacity-50"
                  >
